 ...
 * generated in the br.edu.facthus.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _Soma_QNAME = new QName("http://ws.facthus.edu.br/", "soma");
    private final static QName _SomaResponse_QNAME = new QName("http://ws.facthus.edu.br/", "somaResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.edu.facthus.client
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://ws.facthus.edu.br/", name = "soma")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.facthus.edu.br/", name = "somaResponse")
